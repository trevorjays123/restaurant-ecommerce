...
const sampleMenuItems: MenuItem[] = [
  ...
  },
  {
    ...
    category: 'Starters',
    cuisine: 'nigerian',
    images: ['/images/nigerian/suya.jpg'],
    thumbnail: '/images/nigerian/suya.jpg',
    dietary: [],
    available: true,
    preparationTime: 15,
    popular: true,
  ...
  },
  {
    ...
    category: 'Mains',
    cuisine: 'nigerian',
    images: ['/images/nigerian/poundedyam.jpg'],
    thumbnail: '/images/nigerian/poundedyam.jpg',
    dietary: [],
    available: true,
    preparationTime: 25,
    rating: 4.7,
  ...
  },
  {
    ...
    category: 'Mains',
    cuisine: 'continental',
    images: ['/images/continental/steak.jpg'],
    thumbnail: '/images/continental/steak.jpg',
    dietary: ['gluten-free'],
    available: true,
    preparationTime: 30,
    rating: 4.8,
  ...
  },
  {
    ...
    category: 'Starters',
    cuisine: 'continental',
    images: ['/images/continental/salad.jpg'],
    thumbnail: '/images/continental/salad.jpg',
    dietary: ['vegetarian'],
    available: true,
    preparationTime: 10,
    rating: 4.5,
  ...
  },
  {
    ...
    category: 'Pizza',
    cuisine: 'fastfood',
    images: ['/images/fastfood/pizza.jpg'],
    thumbnail: '/images/fastfood/pizza.jpg',
    dietary: [],
    available: true,
    preparationTime: 20,
    popular: true,
  ...
  },
  {
    ...
    category: 'Wings',
    cuisine: 'fastfood',
    images: ['/images/fastfood/wings.jpg'],
    thumbnail: '/images/fastfood/wings.jpg',
    dietary: [],
    available: true,
    preparationTime: 15,
    rating: 4.5,
